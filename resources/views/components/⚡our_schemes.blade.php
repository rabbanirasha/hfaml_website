...
new class extends Component
{
    public function render(){
        return $this->view()->title("Our Schemes");
    }
}
?>
...
<div>
    <section><!-- Start: About Us -->
        <div class="container my-5 rounded-1 p-2 rounded-bordered" style="background-color: var(--bs-body-bg);">
            <h1 class="fw-bold pt-3 text-primary" style="text-align: center;">Our Schemes</h1>
            <hr style="border-style: inset;">
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                <div class="col my-2">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center p-4">
                            <div class="bs-icon-lg mb-5 mx-auto bs-icon rounded shadow" style="top: 1rem;right: 1rem;"><i class="bi bi-graph-up"></i></div>
                            <h5 class="fw-bold card-title">Lump Sum Investment</h5>
                            <p class="text-muted card-text" style="text-align: justify;">If you possess a large cash windfall and looking for a place to invest in that generates immediate and high returns, then lump sum investment is for you!<br><br>Buy units from any of our mutual funds as one-time investment and receive attractive dividends.</p>
                        </div>
                    </div>
                </div>
                <div class="col my-2">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="fw-bold card-title">Systematic Investment Plan (SIP)</h5>
                            <p class="text-muted card-text" style="text-align: justify;">If you earn a regular income and can save a fixed amount each time, then Systematic Investment Plan is for you! Highly recommended as it awards you greater returns in the long run.<br><br>Buy units from any of our mutual funds monthly / half-yearly / yearly as recurring investment and receive attractive dividends. </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                ...
                <h4 class="fw-bolder text-center" style="color: #2c4fc3;">Receive Dividends the way you like</h4>
                <hr class="hr-warning mx-auto" style="background-color: #2c4fc3;height: 5px;width: 80px;margin-top: -5px;">
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                <div class="col my-2">
                    <div class="card h-100 text-white" style="background-color: #2c4fc3;">
                        <div class="card-body text-center p-4">
                            <div class="bs-icon-lg mb-2 mx-auto bs-icon rounded text-white" style="top: 1rem;right: 1rem;"><i class="bi bi-cash-coin"></i></div>
                            <h5 class="fw-bold card-title">Cash</h5>
                            <hr style="border-style: inset;">
                            <p class="card-text">Receive dividends in the form of cash that goes to your bank account.</p>
                        </div>
                    </div>
                </div>
                <div class="col my-2">
                    <div class="card h-100 text-white" style="background-color: #2c4fc3;">
                        <div class="card-body text-center p-4">
                            <div class="bs-icon-lg mb-2 mx-auto bs-icon rounded text-white" style="top: 1rem;right: 1rem;"><i class="bi bi-arrow-repeat"></i></div>
                            <h5 class="fw-bold card-title">Cumulative Investment Plan (CIP)</h5>
                            <hr style="border-style: inset;">
                            <p class="card-text">Receive dividends in the form of mutual fund units that goes to your BO Account as reinvestment.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-10 col-xl-10 text-center mx-auto">
                    <h4 class="fw-bolder text-center" style="color: #2c4fc3;">Benefits of SIP</h4>
                    <hr class="hr-warning mx-auto" style="background-color: #2c4fc3;height: 5px;width: 80px;margin-top: -5px;">
                </div>
